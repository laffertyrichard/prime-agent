...
- Fixed persisted session paths preventing Anthropic prompt-cache reuse across equivalent RLM subagent prompts ([#1320](https://github.com/PrimeIntellect-ai/prime-agent/issues/1320)).
