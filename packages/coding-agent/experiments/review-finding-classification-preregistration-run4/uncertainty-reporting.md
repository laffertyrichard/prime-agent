...
Report all failures and abstentions by opaque pair ID after scoring. Do not expose gold rationales in reviewer prompts or raw-output directories. No confidence threshold, interval bound, or calibration statistic changes the preregistered conclusion.
